(() => {
  ...
  // src/js/examples/conditional.js
  ...
  \u00D8("val1").create({ x: 4, y: 10 }, Value2, "blue");
  \u00D8("equals").create({ x: 10, y: 10 }, Equals2);
  \u00D8("console").create({ x: 26, y: 10 }, Console2);
  \u00D8("red").create({ x: 18, y: 4 }, Bang2);
  \u00D8("green").create({ x: 18, y: 8 }, Bang2);
  \u00D8("blue").create({ x: 18, y: 12 }, Bang2);
  \u00D8("else").create({ x: 18, y: 16 }, Bang2);
